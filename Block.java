...
//		byte[] arr = new byte[8];
//		byte[] arr2 = new byte[LinearHash.sectionsize-8];	
//		
//		for(int x=0;x<=LinearHash.blocksize-LinearHash.sectionsize;x = x + LinearHash.sectionsize)		//sysout for debugging
//		{
//			for(int k=0;k<8;k++)
//			{
//				arr[k] = blockdata[k + x];
//			}
//			for(int k=8;k<LinearHash.sectionsize;k++)
//			{
//				arr2[k-8] = blockdata[k + x];
//			}
//		
//			//System.out.print("\nRecord pointer at Offset " + x + ": " +LinearHash.toLong(arr) + "\nData at Offset " + x + ": " +arr2 );
//		}

...
public class DataTypeHandler_i4 implements DataTypeHandlerInterface
{
	...
	public String readInfo(RandomAccessFile sourceheapfile, long heapfileptr,int size) throws IOException
	{
		...
		Integer i = sourceheapfile.readInt();
	...
	{
		if(Integer.parseInt(field) == Integer.parseInt(value))
			return 0;
		
		else if(Integer.parseInt(field) >= Integer.parseInt(value))
			return 1;
	...
	{
		Integer d = ConversionClass.toInt(b);

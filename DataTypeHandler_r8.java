...
public class DataTypeHandler_r8 implements DataTypeHandlerInterface
{
	...
	public String readInfo(RandomAccessFile sourceheapfile, long heapfileptr,int size) throws IOException
	{
		...
		Double i = sourceheapfile.readDouble();
	...
	{
		if(Double.parseDouble(field) == Double.parseDouble(value))
			return 0;
		
		else if(Double.parseDouble(field) >= Double.parseDouble(value))
			return 1;
	...
	{
		Double d = ConversionClass.toDouble(b);
